...
import { Cpu, MemoryStick, HardDrive, Clock3, Activity } from "lucide-react";
    ...
    <Link href={href} className="block">
      <Card interactive padding="p-0" className="relative overflow-hidden">
        ...
        <div className="p-4 pl-5">
          ...
          <div className="font-display mt-3 text-[17px] font-semibold text-color-text">{n.hostname}</div>
          <div className="mt-0.5 text-sm text-text-faint">{n.ip_address}:{n.exporter_port}</div>
